...
class OpenApiExample(OpenApiSchemaBase):
    ...
    def __init__(
            ...
            parameter_only: Optional[Tuple[str,
                                           _ParameterLocationType]] = None,
...
class OpenApiParameter(OpenApiSchemaBase):
    ...
    def __init__(
            self,
            name: str,
            type: Union[_SerializerType, _KnownPythonTypes,
                        OpenApiTypes, dict] = str,
...
def extend_schema(
        ...
        parameters: Optional[Sequence[Union[OpenApiParameter,
                                            _SerializerType]]] = None,
        request: Any = empty,
        responses: Any = empty,
        ...
        for method_name, method_decorator in kwargs.items():
            ...
            if hasattr(method_decorator, '__iter__'):
                for sub_method_decorator in method_decorator:
                    sub_method_decorator(
                        isolate_view_method(view, method_name))
            else:
